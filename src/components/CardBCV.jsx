  ...
  return (
    <div className="w-60 sm:w-96 mx-auto mt-2 mb-12 my-0 px-8 pt-4 pb-8 rounded-xl border border-b-4 border-gray-600 shadow-md bg-white">
      ...
      <div className="w-56 sm:w-[23.5rem] relative ml-[-0.65rem] py-1 px-4 rounded-t-md rounded-b-md bg-yellow-300">
        <p className="m-0 pt-2 flex text-3xl font-medium before:content-['VES'] before:mr-1 before:font-light before:text-[14px] sm:before:text-[18px]  after:content-['/_1$'] after:ml-1 after:font-light after:text-[14px] sm:after:text-[18px]">19.24</p>
